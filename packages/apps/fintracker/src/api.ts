...
export const api = {
  ...
  updateGoldHistory: (p: Record<string, unknown>) => post<boolean>({ module: 'gold', action: 'updateHistory', ...p }),
  deleteGoldHistory: (id: string)                 => post<boolean>({ module: 'gold', action: 'deleteHistory', id }),
